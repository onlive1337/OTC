...
📞 @onswix — связь""",
        ...
        'number_too_large': "Число слишком большое. Максимум: {max_amount}.",
        'number_too_small': "Сумма слишком маленькая. Минимум: {min_amount}.",
        'about_button': "О боте",
...
Формат: 100 USD, 50 евро, 1000 рублей, 10к долларов""",
   'invalid_amount_or_too_large': "⚠️ Не удалось распознать сумму. Проверьте формат числа (например, 100.50 USD).",
   ...
   'math_result_short': "{expression} = <b>{result}</b>",
   'math_result_long': "{expression}\n= <b>{result}</b>",
   'no_admin_rights': "У вас нет прав для выполнения этой команды.",
   'broadcast_cancel_button': "❌ Отмена",
   'broadcast_send_button': "✅ Отправить",
   ...
   'broadcast_msg_not_found': "⚠️ Сообщение не найдено. Попробуйте снова.",
   'broadcast_started': "📤 Рассылка начата...",
   'broadcast_progress': "📤 Рассылка... {processed}/{total} ({percent}%)",
   'broadcast_done': "📢 <b>Рассылка завершена</b>\n\n✅ Отправлено: {sent}\n🚫 Заблокировали: {blocked}\n❌ Ошибки: {failed}\n📊 Всего: {total}",
   'broadcast_unsupported_type': "⚠️ Этот тип сообщения не поддерживается. Отправьте текст, фото, видео, документ или стикер.",
   'broadcast_preview': "📢 <b>Предпросмотр рассылки</b>\n\nТип: {msg_type}\n👥 Получатели: {total_users} пользователей\n\nОтправить?",
    },
    'en': {
...
📞 @onswix — contact""",
        ...
        'number_too_large': "Number is too large. Maximum: {max_amount}.",
        'number_too_small': "Amount is too small. Minimum: {min_amount}.",
        'about_button': "About",
        'about_message': "Onlive Twilight Convert",
...
Format: 100 USD, 50 euro, 1000 rubles, 10k dollars""",
   'invalid_amount_or_too_large': "⚠️ Could not parse amount. Check number format (e.g., 100.50 USD).",
   ...
   'broadcast_cancel_button': "❌ Cancel",
   'broadcast_send_button': "✅ Send",
   'broadcast_title': "📢 <b>Broadcast</b>",
   'broadcast_prompt': "Send the message you want to deliver to all users.\nSupported types: text, photo, video, document, and sticker.\n\nPress the button below to cancel.",
   'broadcast_cancelled': "❌ Broadcast canceled.",
   'broadcast_msg_not_found': "⚠️ Message not found. Please try again.",
   'broadcast_started': "📤 Broadcast started...",
   'broadcast_progress': "📤 Broadcasting... {processed}/{total} ({percent}%)",
   'broadcast_done': "📢 <b>Broadcast completed</b>\n\n✅ Sent: {sent}\n🚫 Blocked: {blocked}\n❌ Failed: {failed}\n📊 Total: {total}",
   'broadcast_unsupported_type': "⚠️ This message type is not supported. Send text, photo, video, document, or sticker.",
